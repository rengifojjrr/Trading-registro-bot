...
- **Abre en cinco minutos, no en uno.** Treinta velas antes y setenta después son hora y media de gráfico, y en hora y media de velas de un minuto no se aprecia la reacción a una noticia: se ve el ruido de dentro del movimiento, no el movimiento. En cinco minutos la misma cantidad de velas cubre ocho horas, así que entran los cuatro plazos que se miden y se ve la forma entera. No cuesta una petición: el servidor ya trae trescientas velas de un minuto --las necesita para medir con precisión-- y de ellas salen las de cinco juntándolas en el cliente (`aggregateCandles`, alineadas con el reloj para que la vela del dato empiece exactamente a las 12:30).
- **Topes alrededor de la publicación** (24 h antes, 48 h después). Esto era **el gráfico corriéndose solo hacia la derecha al alejar el zoom**, y el motivo es más tonto de lo que parecía: el cargador del borde derecho pedía hasta *ahora mismo*, y para una noticia de junio eso son tres meses de velas disponibles. Alejar el zoom dejaba hueco, el cargador traía trescientas velas, seguía habiendo hueco, y vuelta a empezar. Medido en un navegador con la misma lógica: **18.361 velas sin tope contra 583 con él**, y sin tope arrancaba ya al abrir. El encuadre inicial se recorta además a las velas que de verdad hay, que era la otra mitad del mismo problema.
