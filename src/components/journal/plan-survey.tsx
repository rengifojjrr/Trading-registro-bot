...
export function PlanSurvey({ plan, onClose }: { plan: TradePlan; onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex shrink-0 items-start justify-between gap-3 border-b border-border bg-gradient-to-br from-primary/10 via-card to-card px-5 pb-4 pt-4">
