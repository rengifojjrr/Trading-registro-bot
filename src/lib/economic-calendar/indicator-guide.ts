...
const REGLAS: Regla[] = [
  ...
  },
  {
    ...
    guide: {
      ...
      porEncima: "Más peticiones de las previstas apuntan a un mercado laboral que se enfría.",
      porDebajo: "Menos peticiones apuntan a un mercado laboral que aguanta fuerte.",
  ...
  },
  {
    ...
    guide: {
      ...
      porDebajo: "Menos vacantes indican que la demanda de trabajo se enfría.",
  ...
  },
  {
    ...
    guide: {
      ...
      porEncima: "Una lectura mejor de lo previsto apunta a una economía más fuerte de lo que se creía.",
      porDebajo: "Peor de lo previsto apunta a enfriamiento.",
  ...
  },
  {
    ...
    guide: {
      ...
      porEncima: "Más confianza de la prevista apunta a que el consumo aguantará.",
      porDebajo: "Menos confianza apunta a que los hogares van a apretarse el cinturón.",
  ...
  },
  {
    ...
    guide: {
      ...
      porEncima: "Más pedidos de los previstos apuntan a empresas invirtiendo con confianza.",
      porDebajo: "Menos pedidos apuntan a inversión en pausa.",
